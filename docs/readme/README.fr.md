...
<p align="center">
  <strong>Zéro Electron. Zéro OpenSSL. Zéro télémétrie. Zéro abonnement. SSH pur Rust.</strong>
  <br>
  <em>Un seul binaire natif — shells locaux, SSH, SFTP, IDE distant, IA, redirection de ports, plugins, 30+ thèmes, 11 langues.</em>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/version-1.1.20-blue" alt="Version">
  ...
  <img src="https://img.shields.io/github/downloads/AnalyseDeCircuit/oxideterm/total?color=brightgreen" alt="Téléchargements totaux">
</p>
...
<p align="center">
  ...
  <a href="https://github.com/AnalyseDeCircuit/oxideterm/releases">
    <img src="https://img.shields.io/github/v/release/AnalyseDeCircuit/oxideterm?include_prereleases&label=Télécharger%20la%20dernière%20bêta&style=for-the-badge&color=orange" alt="Télécharger la dernière bêta">
  </a>
</p>
...
<table>
<tr>
<td align="center"><strong>271K+</strong><br/><sub>Lignes de code</sub></td>
<td align="center"><strong>83%</strong><br/><sub>Densité du code</sub></td>
<td align="center"><strong>24K+</strong><br/><sub>Lignes de tests</sub></td>
<td align="center"><strong>84</strong><br/><sub>Fichiers de test</sub></td>
<td align="center"><strong>910</strong><br/><sub>Fichiers source</sub></td>
</tr>
</table>

<sub>TypeScript 102K · Rust 62K · ratio tests/code 9,1% · aucun framework de test externe</sub>
...
Téléchargez la dernière version depuis [GitHub Releases](https://github.com/AnalyseDeCircuit/oxideterm/releases/latest).

| Plateforme | Dépendance runtime |
|---|---|
| **Windows** | [WebView2 Runtime](https://developer.microsoft.com/en-us/microsoft-edge/webview2/) — préinstallé sur Windows 10 (1803+) et Windows 11. Pour les environnements **hors ligne / intranet**, utilisez l'[installateur autonome Evergreen](https://developer.microsoft.com/en-us/microsoft-edge/webview2/#download) (hors ligne, ~170 Mo) ou déployez le runtime en **version fixe** via les stratégies de groupe. |
...
<p align="center">
  <sub>271 000+ lignes de Rust & TypeScript — construit avec ⚡ et ☕</sub>
</p>
