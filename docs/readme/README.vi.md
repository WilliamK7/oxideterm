...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.1.18-blue" alt="Phiên bản">
...
| Công cụ phụ thuộc cloud, yêu cầu tài khoản | **Ưu tiên cục bộ**: không tài khoản, không telemetry — dữ liệu của bạn mặc định ở trên máy bạn. Tự cung cấp API key AI. Đồng bộ cloud tùy chọn qua [plugin chính thức](#plugin-chính-thức) |
...
- **24 chế độ ngôn ngữ**: 14 CodeMirror gốc + chế độ kế thừa qua `@codemirror/legacy-modes`
...
- **Agent từ xa** (tùy chọn): nhị phân Rust ~1 MB, triển khai tự động trên x86_64/aarch64 Linux. Với các kiến trúc khác, người dùng phải tự biên dịch agent từ mã nguồn rồi tải lên thủ công. Kích hoạt cây tệp nâng cao, tìm kiếm biểu tượng và theo dõi tệp.
...
| **Quick Commands** | Thực thi lệnh một chạm — lưu, tổ chức và chạy các lệnh terminal thường dùng với bộ lọc theo host | [oxideterm.quick-commands](https://github.com/AnalyseDeCircuit/oxideterm.quick-commands) |
