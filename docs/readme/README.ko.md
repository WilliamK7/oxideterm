...
<p align="center">
  <img src="https://img.shields.io/badge/version-1.1.18-blue" alt="버전">
...
- **원격 에이전트**(선택적): 약 1 MB Rust 바이너리, x86_64/aarch64 Linux에 자동 배포. 다른 아키텍처에서는 사용자가 소스에서 에이전트를 직접 빌드한 후 수동으로 업로드해야 합니다. 향상된 파일 트리, 심볼 검색, 파일 감시 활성화.
