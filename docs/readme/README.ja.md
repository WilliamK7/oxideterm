...
<p align="center"><em>🤖 AI アシスタント —「ローカルターミナルを開いて echo hello, world! を実行」</em></p>
...
| **AI** | インラインパネル + サイドバーチャット、SSEストリーミング、コード挿入、40以上のツール利用、MCPサーバー統合、マルチソースコンテキスト、OpenAI/Ollama/DeepSeek |
