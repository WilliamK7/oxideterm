...
<p align="center">
  <strong>Terminal local + SSH + SFTP + IA en una sola app nativa.</strong>
  <br>
  <em>Sin Electron. Sin OpenSSL. Pila SSH en Rust puro.</em>
</p>
...
<p align="center">
  <a href="https://github.com/AnalyseDeCircuit/oxideterm/releases/latest">
    <img src="https://img.shields.io/github/v/release/AnalyseDeCircuit/oxideterm?label=Descargar&style=for-the-badge&color=brightgreen" alt="Descargar última versión">
  </a>
</p>
...
<table>
<tr>
<td align="center"><strong>Terminal SSH + OxideSens AI</strong><br/><br/><img src="../screenshots/terminal/SSHTERMINAL.png" alt="Terminal SSH con barra lateral OxideSens AI" /></td>
<td align="center"><strong>Gestor de archivos SFTP</strong><br/><br/><img src="../screenshots/sftp/sftp.png" alt="Gestor de archivos SFTP de doble panel" /></td>
</tr>
<tr>
<td align="center"><strong>IDE integrado (CodeMirror 6)</strong><br/><br/><img src="../screenshots/miniIDE/miniide.png" alt="Modo IDE integrado con CodeMirror 6" /></td>
<td align="center"><strong>Redirección de puertos inteligente</strong><br/><br/><img src="../screenshots/PORTFORWARD/PORTFORWARD.png" alt="Redirección de puertos con auto-detección" /></td>
</tr>
</table>
...
- Tiempo de inactividad (configurable: 5min / 15min / 30min / 1h / nunca), keep-alive (15s), detección de fallos por heartbeat
...
Una herramienta CLI independiente que se comunica con la GUI de OxideTerm en ejecución vía IPC:

- **Protocolo**: JSON-RPC 2.0 sobre Unix Domain Socket (macOS/Linux) o Named Pipe (Windows)
- **Comandos**: `oxt status`, `oxt list connections`, `oxt list sessions`, `oxt ping`
- **Modos de salida**: detección automática de formato legible, `--json` para scripts
- **Distribuido con GUI**: integrado en el paquete, instalable desde Configuración → General a `~/.local/bin/`
- **Seguridad**: máx. 16 conexiones simultáneas, límite de solicitud 1 MB, timeout inactivo 60s, permisos Socket solo propietario
...
| **CLI** | Herramienta `oxt`, IPC JSON-RPC, estado/lista/ping, salida legible + JSON, instalación integrada |
