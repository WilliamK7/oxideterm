...
pub fn run() {
    ...
    let builder = builder.invoke_handler(tauri::generate_handler![
        ...
        commands::clear_tree_node_terminal,
        ...
        commands::config::export_saved_connections_snapshot,
        commands::config::get_local_sync_metadata,
        ...
        commands::config::apply_saved_connections_snapshot,
        ...
        commands::config::check_data_directory,
        commands::config::open_log_directory,
        ...
        commands::list_all_saved_forwards,
        commands::export_saved_forwards_snapshot,
        commands::apply_saved_forwards_snapshot,
